...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <div class="sservices">
                <div class="sservices-title">
                    <p><a href="index.php">Home  /</a> <a href="services.php">  Our Services</a></p>
                    <h1>Our Services</h1>
                </div>
        ...
        <!--Functions to enable the pop up effect -->
        <script>
            function openModal(modalId) {
                document.getElementById(modalId).style.display = "flex"; // Show modal
                document.querySelector('body').classList.add('blurred'); // Blur the background
            }

            function closeModal(modalId) {
                document.getElementById(modalId).style.display = "none"; // Hide modal
                document.querySelector('body').classList.remove('blurred'); // Remove blur
            }

            function closeModalOnOutsideClick(event, modalId) {
                const modalContent = document.querySelector(`#${modalId} .modal-content`);
                if (!modalContent.contains(event.target)) {
                    closeModal(modalId); // Close modal if click is outside the modal content
                }
            }
