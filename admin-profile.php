        ...
        <main>
            <div class="profile-container">
                ...
                <div class="profile-details">
                    ...
                    <!--Code to allow user profile image comes here soon-->
                    ...
                    <div class="profile-section1">
                        ...
                        <div id="editForm" style="display: none;">
                            <form class="admin-profile" action="update_profile.php" method="POST">
                                <label for="new_username">New Username:</label>
                                <input type="text" id="new_username" name="new_username" required value="<?php echo htmlspecialchars($user['username']); ?>">
                ...
                <div class="footer-container">
                    ...
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="about-u3.php">About Us</a></li>
