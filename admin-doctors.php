            ...
            <div class="profile-container">
                ...
                <div class="profile-details">
                    ...
                    <div class="view-table">
                        ...
                        // Fetch all doctors' usernames, emails, and passwords
                        $stmt = $conn->prepare("SELECT username, email, password FROM doctors");
                        $stmt->execute();
                        ...
                        if ($doctors_result->num_rows > 0) {
                            echo "<h2>Doctors</h2>";
                            echo "<table>";
                            echo "<tr><th>Doctor's Username</th><th>Email</th><th>Password</th></tr>";
