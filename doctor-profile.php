                ...
                <div class="profile-details">
                    ...
                    <div class="profile-section1">
                        ...
                        <div id="editForm" style="display: none;">
                            <form class="admin-profile" action="update_doctor-profile.php" method="POST">
                                <label for="new_username">New Username:</label>
                                <input type="text" id="new_username" name="new_username" required value="<?php echo htmlspecialchars($doctor['username']); ?>">
