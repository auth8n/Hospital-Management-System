                ...
                <div class="profile-details">
                    ...
                    <div class="view-table">
                        ...
                        if (!isset($_SESSION['id'])) {
                            ...
                            // Optionally, display the user ID for debugging
                        ...
                        $stmt->bind_param("i", $user_id);  // Bind the correct user ID
                        $stmt->execute();
                        ...
                        $stmt = $conn->prepare("SELECT a.id, a.appointment_date, a.appointment_time, d.username AS doctor_name 
                        FROM appointments a 
                        JOIN doctors d ON a.doctor_id = d.doctor_id 
                        WHERE a.user_id = ?");

                        $stmt->bind_param("i", $user_id); // Bind the user_id for fetching appointments
                        $stmt->execute();
                        ...
                        if ($appointments_result->num_rows > 0) {
                            echo "<table>";
                            echo "<tr><th>Doctor's Name</th><th>Appointment Time</th><th>Appointment Date</th></tr>";
